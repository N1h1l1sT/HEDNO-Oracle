...
'Needs ModuleStrings Version 1.4

Imports System.Drawing.Printing

Public Class clsDataGridViewPrinter
    ...
    Private Shared CurrentRow As Integer            ' A static parameter that keep track on which Row (in the DataGridView control) that should be printed
    ...
    Public Sub New(ByVal aDataGridView As DataGridView, ByVal aPrintDocument As PrintDocument, ByVal CenterOnPage As Boolean, ByVal WithTitle As Boolean, ByVal aTitleText As String, ByVal aTitleFont As Font, ByVal aTitleColor As Color, ByVal WithPaging As Boolean)
        ...
        If Not ThePrintDocument.DefaultPageSettings.Landscape Then
            PageWidth = ThePrintDocument.DefaultPageSettings.PaperSize.Width - 57 'added: -57 to make all columns printable even if some column is very wide
            PageHeight = ThePrintDocument.DefaultPageSettings.PaperSize.Height
        Else
            PageWidth = ThePrintDocument.DefaultPageSettings.PaperSize.Height - 57 'added: -57 to make all columns printable even if some column is very wide
    ...
    Private Sub Calculate(ByVal g As Graphics)
        If (PageNumber = 0) Then
            ...
            ' By default, the wrapping will occurr so that the maximum number of columns for a page will be determined
            Dim k As Integer
