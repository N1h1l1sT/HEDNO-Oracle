...
Module modChangeLanguage
    ...
    Public Sub Main_Language(ByVal frm As frmMain)
        With frm
            ...
            .mniActionsMenu.Text = strLanguage_Main(9)
            ...
            .mniRegister.Text = strLanguage_Main(19)
            .mniRevokeRegistration.Text = strLanguage_Main(20)
            ...
            '.cmdExpirationDate.Text = strLanguage_Main(27)
            .mniShowExpirationDate.Text = strLanguage_Main(27)
            ...
            .mniToggleVisibility.Text = strLanguage_Main(48)
            ...
            .mniRegister.ToolTipText = strLanguage_Main_Tips(24)
            .mniRevokeRegistration.ToolTipText = strLanguage_Main_Tips(25)
            .mniShowExpirationDate.ToolTipText = strLanguage_Main_Tips(26)
            '.tltMain.SetToolTip(.cmdExpirationDate, strLanguage_Main_Tips(26))
            .mniMDIWindows.ToolTipText = strLanguage_Main_Tips(27)
            .mniToggleVisibility.ToolTipText = strLanguage_Main_Tips(28)
